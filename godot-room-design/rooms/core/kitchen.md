...
## Ideas & inspiration
- Note your work triangle: sink, stove, fridge positions matter more than exact cabinet counts.
- Islands and peninsulas define traffic flow — sketch the walking paths.
- Under-cabinet LED strips are cheap to model and make the scene pop.
